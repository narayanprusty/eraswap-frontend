...
class WalletManager extends React.Component{
    ...
    render(){
        ...
        return (
        <div >
            <Card title={this.props.header} style={{ width: '50.2%' ,  border : '0px solid' , borderRadius: '10px', backgroundColor:'#fce9de', zIndex :'9999', clear:'both' , display: 'inline-block', float: 'left' , top:'20px',  }}>      
            ...
            <Card title={this.props.header1} style={{  border : '5px solid #ffae57' , borderRadius: '10px', backgroundColor:'transperant', zIndex :'9999' ,clear:'both' , display: 'inline-block', width: '30.1%', top:'20px' }}>      
               <Link to="/wallet/Btc">
                <div style={{marginBottom: '0.5%', fontSize: '20px' , fontWeight: 'bold'}}> 
                <img src={bitcoinSvg} className={s.icoStyle} width='70px' />
                <br />
                <br />
                    Bitcoin
             ...
             <Card title={this.props.header1} style={{ border : '5px solid #ffae57' , borderRadius: '10px', backgroundColor:'transperant', zIndex :'9999' ,clear:'both' , display: 'inline-block', width: '30.1%' , top:'20px' }}>      
                <Link to="/wallet/Eth">
                <div style={{marginBottom: '0.5%', fontSize: '20px' , fontWeight: 'bold'}}> 
                <img src={ethereumSvg} className={s.icoStyle} width='70px' />
                <br />
                <br />
                    Ethereum
             ...
             <Card title={this.props.header1} style={{ border : '5px solid #ffae57' , borderRadius: '10px', backgroundColor:'transperant', zIndex :'9999' ,clear:'both' , display: 'inline-block', width: '30.1%' , top:'20px' }}>      
               <Link to="/wallet/Est">
                ...
                <img src={estSvg} className={s.icoStyle} width='70px' />
                <br />
                <br />
                    EST Token
