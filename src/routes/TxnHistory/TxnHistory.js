...
class TxnHistory extends React.Component {
  ...
  conVertObjToArr = wholeObj => {
    return [
      ...
      {
        title: `Your ${wholeObj.exchToCurrency} Receiving Address`,
      ...
      },
      {
        ...
        content: wholeObj.platform_fee
          ? wholeObj.platform_fee + ' ' + wholeObj.platformFeePayOpt == 'source'
  ...
  render() {
    const columns = [
      ...
      },
      {
        ...
        align: 'center',
        render: (exchFromCurrency, record) => {
          return exchFromCurrency + '/' + record.exchToCurrency;
        },
      },
      {
