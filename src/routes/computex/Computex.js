        ...
        {/* <Card title={this.props.title}> */}
          ...
          >
            <Panel
              ...
              className={s.blue}
            >
            <span className={s.icoBullet}>*Please Enter the amount excluding the txn Fee</span>
              <Form onSubmit={this.handleSubmit}>
                <FormItem label="Convert">
                  ...
                  {/* <Select
                    ...
                    style={{ width: '32%', borderColor: '#ccc', borderWidth: '2px' }}
                  >
                ...
                <FormItem label="To">
                  {/* <Select
                    ...
                    onSearch={this.fetchCurrency}
                    onChange={this.handletoCurrencyChange}
                    style={{ width: '60%', borderColor: '#000000', borderWidth: '2px'  }}
                  >
                    {state.cur.map(d => <Option key={d.value}>{d.name}</Option>)}
                  </Select> */}
                  <Select
            ...
            >
              ...
              <blockquote>
                {' '}
                <span className={s.icoBullet}>* Best price [in USD] selected automatically</span>
              </blockquote>{' '}
              &nbsp; <br />
            ...
            <Panel
              ...
              className={s.blue}
            >
             <span className={s.icoBullet}> We will be exchange through {this.state.maxExchange}. please
              transfer {this.state.amount + ' ' + this.state.currency} to this
              below address: </span><br />
